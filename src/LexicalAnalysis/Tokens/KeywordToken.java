...
public class KeywordToken extends Token {
    ...
    static final Set<String> KEYWORDS = Set.of("var", "int", "real", "string", "bool", "while", "for", "loop", "if", "then", "else", "end", "print", "empty", "func", "not", "true", "false", "is", "return", "in", "readInt", "readReal", "readString");
